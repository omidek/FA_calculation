...
function [SrcSample, SrcSampleNormals,sampledIndices]=sample_pc_stable(Src, NormalsSrc, numPoints)
...
nSample = floor(max(numPoints / 10, 10));
indices = 1:floor((n-1)/nSample):n;
